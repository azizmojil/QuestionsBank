...
- **Auto-generated fields:** `SURVEY_VERSION.version_label` is auto-generated from survey code, interval, and version date. Unique constraints exist on `(survey, version_label)`, `(indicator, name)`, `(indicator, classification)`, and each M2M join table pair.
